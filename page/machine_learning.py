...
def machine_learning():
    ...
    st.markdown('<div class="text_indent"> ก่อนที่เราจะเข้าไปในเนื้อหาของการเตรียมข้อมูล (Data Preparation) ในบทความนี้ เราจะมาดูกันว่าแต่ละประเภทของข้อมูลเหล่านี้มีความสำคัญอย่างไรในการพยากรณ์อุณหภูมิและการนำมาวิเคราะห์ในขั้นตอนต่างๆ</div><br><br>', unsafe_allow_html=True)
